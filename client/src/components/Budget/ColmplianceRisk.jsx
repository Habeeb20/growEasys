...
// Component for Compliance, Risk & ESG
const ComplianceRiskESG = () => (
  <div className="space-y-6">
    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Compliance, Risk & ESG</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {complianceData.map((item, index) => (
        <ProgressCircle key={index} {...item} />
      ))}
    </div>
    {/* Alert card for risks */}
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
...
export default ComplianceRiskESG